...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, datasets, p_datasets, samples_per_epoch, max_gap,
                 ...
                 train_cls=False, pos_prob=0.5, max_seq_len=40, bert_model='bert-base-uncased', bert_path=None):
        """
        args:
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                template_frames_path = dataset.get_path(seq_id, template_frame_ids)
                ...
                data = TensorDict({'template_frames_path': template_frames_path,
